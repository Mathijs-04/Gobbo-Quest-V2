...
forever(function () {
    if (arrowVar == 1 && Gobbo.overlapsWith(Arrow1)) {
        for (let index = 0; index < 1; index++) {
            sprites.destroy(Reaper1)
            sprites.destroy(Reaper2)
